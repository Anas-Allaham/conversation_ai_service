...
The merged `conversation_ai.agent` tutor pipeline keeps its normal conversation
behavior and captures word timings for shared fluency measurement. Do not lower
these assessment values to improve latency unless a repeatable test shows that
