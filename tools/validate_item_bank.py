...
def main() -> None:
    path = ROOT / "services" / "oral_assessment" / "data" / "item_bank_v0.2.0.json"
    ...
    schemas = [
        ROOT / "services" / "oral_assessment" / "data" / "item_schema.json",
        ROOT / "services" / "oral_assessment" / "data" / "pronunciation_event_schema.json",
        ROOT / "services" / "oral_assessment" / "data" / "pronunciation_result_schema.json",
    ]
